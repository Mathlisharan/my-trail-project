...
import {Alert,AsyncStorage,Button, View, ImageBackground, Text, Image} from 'react-native';

export default class Splashone extends React.Component {
  ...
  render() {
    return (
        <View>
        <ImageBackground source = {require ('D:/tikazizzares/assets/82.png')} style = {{width:'100%', height:'100%',}}>
